...
/**
 * Check whether a given value is an {@link @david/types#ITeam}
...
/**
 * Check whether a given value is an {@link @david/types#IChannel}
 * @param arg - value to check
 * @beta
 */
...
/**
 * Check whether a given value is an {@link @david/types#IMessage}
 * @param arg - value to check
 * @beta
 */
